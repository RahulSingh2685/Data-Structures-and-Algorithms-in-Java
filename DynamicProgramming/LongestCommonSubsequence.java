...
public class LongestCommonSubsequence {
    public static void main(String[] args) {
     String   str1="abcdge";
     String str2="abedg";
     System.err.println(lcs(str1,str2,str1.length(),str2.length()));
     ...
     System.err.println(lcsMemo(str1,str2,str1.length(),str2.length(),dp));
     System.err.println(lcsTab(str1,str2));
